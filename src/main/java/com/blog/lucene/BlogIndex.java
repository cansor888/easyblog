...
public class BlogIndex {
    ...
    * */
    public IndexWriter getIndexWriter() throws Exception{
        //指定lucene索引库的地址
        dir = FSDirectory.open(Paths.get("E:\\soft-install-location\\lucene\\blogmanager"));
        //指定写入器的分词类型,使用IKAnalyzer分词器
    ...
    * */
    public List<Blog> searchIndex(String keyWord) throws Exception{
        ...
        //读取指定lucene索引库的地址
        dir = FSDirectory.open(Paths.get("E:\\soft-install-location\\lucene\\blogmanager"));
        //创建IndexReader对象并读取文件
        IndexReader indexReader = DirectoryReader.open(dir);
        //创建IndexSearcher查询对象,并将indexreader传入
        IndexSearcher indexSearcher = new IndexSearcher(indexReader);
        //创建IK分词器对象
        IKAnalyzer ikAnalyzer = new IKAnalyzer();
        //创建QueryParser对象,指定查询范围及分词器
